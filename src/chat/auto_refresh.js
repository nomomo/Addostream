...
export async function chat_auto_refresh_send_message(){
    ...
    var previous_refresh = await nomo_commom.nomo.getVal(auto_refresh_val_name,{"prev_time":(current_time - 60*1000),"count":0,"is_refresh":false});
    ...
    if(previous_refresh.is_refresh && current_time - previous_refresh.prev_time > CHAT_AUTO_REFRESH_MAX_TIME_LIMIT*1000){
        ...
        await nomo_commom.nomo.setVal(auto_refresh_val_name, previous_refresh);
    }
}
