...
const _settings = {
    ...
    m3u8_type : { under_dev:true, category_name:"M3U8 플레이어", category:"m3u8", depth:1, type: "radio", value: "auto", title:"[실험실] M3U8 PLAYER 타입", desc:`M3U8 PLAYER 에서 동영상을 재생하는 방식을 선택합니다.<br />- Auto: http 로 시작하거나 서버에서 차단된 m3u8 을 재생할 수 있지만 연결에 필요한 권한을 요구합니다. M3U8 재생 시 연결 허용 관련 팝업이 뜨는 경우 "도메인 항상 허용" 또는 "모든 도메인 항상 허용" 버튼을 클릭 후 새로고침 하세요.<br />- Legacy: 1.55 버전까지의 방식으로 추가 권한을 요구하지 않지만 일부 m3u8 링크의 재생이 불가능 합니다.`, radio: {auto: {title: "Auto", value:"auto"}, legacy: {title: "Legacy", value:"legacy"} }},
