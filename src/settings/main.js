...
const _settings = {
    ...
    m3u8_maxQuality : { under_dev:true, category_name:"M3U8 플레이어", category:"m3u8", depth:1, type: "checkbox", value: true, title:"[실험실] 항상 최대 화질로 재생", desc:"인터넷 연결 상태에 따라 화질을 자동으로 조절하는 기능을 비활성화 합니다." },
