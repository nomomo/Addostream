...
var streamerArray = [
    ...
    ["lol_peanut", "Peanut"],
    ["faker", "Faker", "faker", "페이커", "이상혁", "상혁", "페온", "우리혁", "페진아", "페"],
    ["nrmtzv", "으음"],
    ["nicegametv", "나겜"],
    ["teaminven", "인벤"],
    ["capta1n_pony", "포니"],
    ["huni", "Huni", "후니", "허승훈"],
    ["sktt1_wolf", "Wolf", "울프", "이재완"],
    ["bang", "Bang", "배준식", "준식", "뱅"],
    ["wpghd321", "류제홍"],
    ...
    ["timeofcreate", "홍랑"],
    ["twitchshow", "트위치쇼"],
    ["kangqui", "강퀴", "강승현", "퀴저씨", "퀴조씨", "퀴어빠", "퀴오빠", "퀴"],
    ...
    ["mata", "마타타마", "마타", "마따"],
    ["lol_khan", "Khan", "칸"],
    ["buzzbean11", "대도서관", "머도서관", "대도", "머도", "나동현"],
    ["mhj1682", "카트문호준", "문호준"],
    ["remguri", "렘쨩"],
    ["heavyrainism", "호무새"],
    ["lck_korea", "LCK Korea", "롤챔스", "롤챔"],
    ["lol_madlife", "매드라이프", "매라", "매멘", "매맨", "ㅁㅁ", "메라", "홍민기"],
    ["lol_helios", "헬리오스"],
    ["pparkshy", "샤이"],
    ["pubgkorea", "PUBGKorea"],
    ...
    ["donaldtrump", "DonaldTrump", "도날드 트럼프", "트럼프", "트황상", "갓럼프", "킹럼프"],
    ["thdlqslek", "쏘입니다"],
    ...
    ["tvcrank", "크랭크"],
    ["tomboaaa", "톰보아", "김보아"],
    ["sutjr1006", "폰폰폰폰폰", "허원석", "폰대관"], // 폰, 궆, 주님
    ["swab85", "승우아빠"],
    ["tst1023", "갱맘", "이창석", "GBM"],
    ["lol_ruler", "룰러어", "룰러", "박재혁"],
    ["sudihomt", "수디홈트", "수디"],
    ["xordn123456", "텔론"],
    ["fareeha", "Fareeha", "파리하"],
    ["nari_cosplay", "나리땽", "나리코스"],
    ["onmumunet", "아무무임", "온무무넷"],
    ["score1992", "스코어", "고동빈", "스고수", "코돈빈"],
    ["nara_kyle", "나라카일", "서지선"],
    ["misschoon", "나미춘", "윤태진", "태콩", "흥미춘", "미스춘"]
];
