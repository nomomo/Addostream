                            ...
                            if(chat_manager !== undefined && ADD_config.chat_memo){
                                ...
                                if(memo_index !== -1){
                                    ...
                                    if(temp_display_name !== undefined){
                                        ...
                                        $userFloor.append("<span class=\"conversation_memo\" style=\"color:red;font-weight:bold;vertical-align:inherit;display:-webkit-inline-box\">&nbsp"+ temp_text +"</span>");
                                    }
                                }
                            }
                        }
                        ...
                        <table class="table table-condensed table-striped table-bordered" style="font-size:12px;margin-bottom:5px;font-family:'Noto Sans KR';table-layout:fixed;">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width:120px;">표시명</th>
                                    <th style="max-width:250px;" class="ADD_under_dev">상세 내용</th>
