...
(async () => {
    ...
    */
    ...
    //////////////////////////////////////////////////////////////////////////////////
    // Twitch API
    async function twitch_api_getUserIDs(/*arr*/){
        // 숫자로 구성된 ids 를 일단 만든다.
        
        // if(arr === undefined || arr === null || arr.length ===0){
        //     return false;
        //     숫자로 구성된 ids 를 구성하여 반환한다.
        // }

        // 기존 리스트 불러오기
        //var ch_ids_array = ADD_config.top_alarm_ID;
        var ch_ids_array = ["a", "b", "c", "d"];
        

        // 저장된 IDs 리스트 불러오기 (key-value)
        // var ch_ids_key_value = ADD_config.top_alarm_ID_pairs;
        var ch_ids_key_value = {"a":"12345","b":"12345"};
        var ch_ids_keys = Object.keys(ch_ids_key_value);
        var new_req = $.grep(ch_ids_array, function(n, j){
            return $.inArray(n, ch_ids_keys) === -1;
        });
        ADD_DEBUG("타겟", new_req);
